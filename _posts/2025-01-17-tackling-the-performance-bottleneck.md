...
> if you derive the implementation for `Ord`, you should also derive all four traits. If you implement it manually, you should also implement all four traits, based on the implementation of `Ord`.
